...
-- Extra awesome library
local vicious = require("vicious")
-- Hacked awful.widget.layoutbox
local layouttext = require("layouttext")
-- Flow layout
...
beautiful.init("/home/niemandkun/.config/awesome/theme.lua")
...
vicious.register(mybattery, vicious.widgets.bat, "power: $2", 60, "BAT0")

-- Create a volume widget
myvolume = wibox.widget.textbox()
vicious.register(myvolume, vicious.widgets.volume, "volume: $1", 1, {"-D", "pulse", "Master"})
...
local function client_shape(cr, width, height)
